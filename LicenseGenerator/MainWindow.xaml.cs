...
namespace LicenseGenerator
{
    ...
    public partial class MainWindow : MetroWindow
    {
        ...
        private void btnSave_Click(object sender, RoutedEventArgs e)
        {
            ...
            else if (txtCPUId.Text == "")
            {
                MessageBox.Show("Please input CPUId");
            }
            else if (txtMACAddress.Text == "")
            {
                MessageBox.Show("Please input MAC Address");
            }
            else if (txtMotherBoardId.Text == "")
            {
                MessageBox.Show("Please input MotherBoard Id");
            }
            else if (txtDiskId.Text == "")
            {
                MessageBox.Show("Please input DiskId");
            }
            ...
            {  // @"F:\Temp.xml"
                try
                {
                    ...
                    DT.Columns.Add("CPUId");
                    DT.Columns.Add("MotherBoardId");
                    DT.Columns.Add("DiskId");
                    DT.Columns.Add("Version");
                    DT.Columns.Add("NoOfDays");
                    DT.Columns.Add("DevCode");
                    DT.Columns.Add("GUID");
                    String guid = Guid.NewGuid().ToString();
                    DT.Rows.Add(new object[] { txtMachineName.Text.ToUpper(CultureInfo.CurrentCulture), txtMACAddress.Text.ToUpper(CultureInfo.CurrentCulture).Replace("-", ""), txtCPUId.Text.ToUpper(CultureInfo.CurrentCulture), txtMotherBoardId.Text.ToUpper(CultureInfo.CurrentCulture), txtDiskId.Text.ToUpper(CultureInfo.CurrentCulture), txtInventorVersion.Text.ToUpper(CultureInfo.CurrentCulture), txtNoofDays.Text.ToUpper(CultureInfo.CurrentCulture), tBox_devCode.Text, guid });
                    //Create a dataset
